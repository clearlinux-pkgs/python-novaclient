...
Version  : 2.35.0
Release  : 23
URL      : http://tarballs.openstack.org/python-novaclient/python-novaclient-2.35.0.tar.gz
Source0  : http://tarballs.openstack.org/python-novaclient/python-novaclient-2.35.0.tar.gz
...
%prep
%setup -q -n python-novaclient-2.35.0
%patch1 -p1
%patch2 -p1
