...
Version  : 4.0.0
Release  : 31
URL      : http://tarballs.openstack.org/python-novaclient/python-novaclient-4.0.0.tar.gz
Source0  : http://tarballs.openstack.org/python-novaclient/python-novaclient-4.0.0.tar.gz
...
%prep
%setup -q -n python-novaclient-4.0.0
%patch1 -p1
%patch2 -p1
