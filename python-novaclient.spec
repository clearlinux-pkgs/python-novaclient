...
Version  : 2.23.2
Release  : 16
URL      : http://tarballs.openstack.org/python-novaclient/python-novaclient-2.23.2.tar.gz
Source0  : http://tarballs.openstack.org/python-novaclient/python-novaclient-2.23.2.tar.gz
...
Patch1: 0001-Enable-OSProfiler-in-novaclient.patch
...
%prep
%setup -q -n python-novaclient-2.23.2
%patch1 -p1
